import Toast from "./component/MyToast";
import { iconsMap, titleMap } from "./utils/config";
const ToastPlugin = {
  install(Vue, options = {}) {
    ...
    function buildProps(args) {
      ...
      else props.type = "topCenter";
      // 默认关闭时间
      if (args[1] && args[1].closeTime) props.closeTime = args[1].closeTime;
      else props.closeTime = 3;
      // 自动关闭
      if (args[1] && Object.prototype.hasOwnProperty.call(args[1], "autoClose"))
        props.autoClose = args[1].autoClose;
      else props.autoClose = true;
      // 默认宽度
      if (args[1] && Object.prototype.hasOwnProperty.call(args[1], "width"))
        props.width = args[1].width;
      else props.width = 300;
      // 默认高度
      if (args[1] && Object.prototype.hasOwnProperty.call(args[1], "height"))
        props.height = args[1].height;
